...
class InboxRightPanel extends StatefulWidget {
  ...
  @override
  State<InboxRightPanel> createState() => _InboxRightPanelState();
}

class _InboxRightPanelState extends State<InboxRightPanel> {
  ...
  Widget renderPanelsBasedOnSegment() {
    ...
    return switch (selectedSegmentButton.first) {
      PagePropsSegmentButton.property => InboxPropsPanel(
        width: panelWidth,
        height: panelHeight,
        props: widget.props,
      ),
